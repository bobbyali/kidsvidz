...
//  KidzVids
//
//  Created by Bobby on 20/03/2015.
//  Copyright (c) 2015 AzukiApps. All rights reserved.
//

import UIKit

class PlaylistEditorViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.setToolbarItems([addButton], animated: false)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        if let playlists = self.playlists {
            let label = playlists.list[indexPath.row]
